...
import '../../utils/helpers.dart'; // Tambahkan import helpers untuk error handling
          ...
          : Padding(
              ...
              child: ListView(
                children: [
                  ...
                  _buildFAQItem(
                    'Bagaimana cara melacak status pengajuan surat?',
                    'Anda dapat melacak status pengajuan surat melalui halaman utama aplikasi. Status akan diperbarui secara real-time setelah admin memproses surat Anda.',
                  ),
                  _buildFAQItem(
                    'Apa yang harus dilakukan jika lupa password?',
                    'Jika Anda lupa password, Anda dapat menggunakan fitur "Lupa Password" pada halaman login. Sistem akan mengirimkan tautan reset password ke email Anda.',
                  ),
                  _buildFAQItem(
                    'Apakah aplikasi ini tersedia di semua perangkat?',
                    'Ya, aplikasi ini dapat diakses melalui smartphone Android dan iOS. Pastikan Anda menggunakan versi terbaru aplikasi untuk pengalaman terbaik.',
                  ),
                ],
              ),
            ),
