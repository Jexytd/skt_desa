// lib/screens/admin/admin_chat_screen.dart - Updated
...
class AdminChatScreen extends StatefulWidget {
  ...
  const AdminChatScreen({Key? key, required this.userId}) : super(key: key);
...
class _AdminChatScreenState extends State<AdminChatScreen> {
  ...
  void initState() {
    super.initState();
    _loadUser();
    _chatProvider.loadMessages(widget.userId, AuthService().currentUser!.uid);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_user?.name ?? 'Chat Pengguna'),
